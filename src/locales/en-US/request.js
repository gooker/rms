export default {
  ...
  'app.request.processError':
    'The program is abnormal, please pay attention to the relevant prompt information (if there is no relevant prompt information, please contact the staff)',
  'app.request.processError2': 'Error occurred, please check the console',
  ...
  'app.request.404':
    'The request sent is for a record that does not exist, and the server is not operating',
