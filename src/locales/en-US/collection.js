...
export default {
  ...
  'webHook.subscribe.required': '请添加订阅',
  ...
  'webHook.queueTestLoad.err': 'Topic测试请求体示例数据格式错误',
  'webHook.queue.loss': '队列丢失: {queue}',
  'webHook.test': '测试',
  'webHook.batchTest': '批量测试',
  'webHook.button.test': '测试',
  'webHook.button.cancel': '取消并关闭',
  'webHook.button.cancel.tip': '该操作会取消正在进行的测试进程, 是否确定继续操作?',
  'webHook.test.pass': '测试通过',
  'webHook.test.fail': '测试失败',
