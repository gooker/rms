export default {
  ...
  'monitor.controller.AGV.tip.rebootAMR': '确定重启小车吗?',
  'monitor.controller.AGV.tip.resetAMR': '确定重置小车吗?',
  'monitor.controller.AGV.tip.customCommandSendSuccess': '{actionContent} 指令下发成功',
  'monitor.controller.AGV.tip.customCommandSendFail': '{actionContent} 指令下发失败',
  'monitor.controller.AGV.tip.cancelMaintain': '确定取消维护小车吗?',
  'monitor.controller.AGV.tip.confirmMaintain': '确定开始维护小车吗?',
  'monitor.controller.AGV.tip.turnOnManualMode': '确定开启手动模式吗?',
  'monitor.controller.AGV.tip.turnOffManualMode': '确定关闭手动模式吗?',
