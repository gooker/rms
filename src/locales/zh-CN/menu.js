export default {
  ...
  'menu.formManger.taskKPIform': '任务报表',
  'menu.formManger.waitingKpiForm': '空等报表',
  'menu.formManger.reportFormInfo': '小车任务工作量',
  'menu.formManger.robotErrorInfo': '报表中心',
  'menu.formManger.detailFroms': '报表详情',
