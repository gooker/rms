export default {
  ...
  'monitor.controller.goCharge.success': '充电命令发送成功',
  'monitor.controller.goCharge.fail': '充电命令发送失败',
  'monitor.controller.Vehicle.tip.rebootAMR': '确定重启小车吗?',
  'monitor.controller.Vehicle.tip.resetAMR': '确定重置小车吗?',
  'monitor.controller.Vehicle.tip.customCommandSendSuccess': '{actionContent} 指令下发成功',
  'monitor.controller.Vehicle.tip.customCommandSendFail': '{actionContent} 指令下发失败',
  'monitor.controller.Vehicle.tip.cancelMaintain': '确定取消维护小车吗?',
  'monitor.controller.Vehicle.tip.confirmMaintain': '确定开始维护小车吗?',
  'monitor.controller.Vehicle.tip.turnOnManualMode': '确定开启手动模式吗?',
  'monitor.controller.Vehicle.tip.turnOffManualMode': '确定关闭手动模式吗?',
