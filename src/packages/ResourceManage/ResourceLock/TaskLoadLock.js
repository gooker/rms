...
import { batchDeleteLoadTaskLock, fetchLoadTaskLockList } from '@/services/commonService';
...
const TaskLoadLock = (props) => {
  ...
  async function deleteTargetLock() {
    RmsConfirm({
      ...
      onOk: async () => {
        const response = await batchDeleteLoadTaskLock(selectedRow);
...
export default memo(TaskLoadLock);
