...
import TaskQueueComponent from '@/pages/TaskQueue/TaskQueueComponent';
...
export default class TaskQueue extends React.PureComponent {
  ...
  render() {
    const deleteFlag = hasPermission('/sorter/task/taskQueue/delete') ? true : false;
    const priority = hasPermission('/sorter/task/taskQueue/updatePipLine') ? true : false;
    return (
      <TaskQueueComponent
