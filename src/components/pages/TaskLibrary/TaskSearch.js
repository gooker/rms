  ...
  function onFinish() {
    form.validateFields().then((values) => {
      ...
      if (values.createDate) {
        params.createTimeStart = GMT2UserTimeZone(values.createDate[0], 1).format('YYYY-MM-DD HH:mm:ss');
        params.createTimeEnd = GMT2UserTimeZone(values.createDate[1], 1).format('YYYY-MM-DD HH:mm:ss');
