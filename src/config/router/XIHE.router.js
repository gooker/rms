export default [
    ...
    routes: [
      {
        ...
        name: 'taskTrigger',
        component: '/Mixrobot/SourceGroupManage/TaskTrigger',
        hooks: ['dev'],
      },
      {
        path: '/mixrobot/sourceGroupManage/TaskLimiting',
        name: 'TaskLimiting',
        component: '/Mixrobot/SourceGroupManage/TaskLimiting',
        hooks: ['dev'],
      },
      {
        path: '/mixrobot/sourceGroupManage/GroupManage',
        name: 'groupManage',
        component: '/Mixrobot/SourceGroupManage/GroupManage',
        hooks: ['dev'],
      },
      {
        path: '/mixrobot/sourceGroupManage/GroupBinding',
        name: 'groupBinding',
        component: '/Mixrobot/SourceGroupManage/GroupBinding',
        hooks: ['dev'],
      },
      {
        path: '/mixrobot/sourceGroupManage/CustomTask',
        name: 'customTask',
        component: '/Mixrobot/SourceGroupManage/CustomTask',
        hooks: ['dev'],
      },
    ],
  },
    ...
    routes: [
      {
        ...
        component: '/Mixrobot/ChargeManage/ChargeManagerment',
        authority: ['ADMIN', 'SUPERMANAGER', 'MANAGER'],
        hooks: ['dev'],
      },
      {
        ...
        component: '/Mixrobot/ChargeManage/ChargeFaultManagement',
        authority: ['ADMIN', 'SUPERMANAGER', 'MANAGER'],
        hooks: ['dev'],
      },
    ],
  ...
  },
  {
    ...
    name: 'operationLog',
    icon: 'iconLOG',
    component: '/Mixrobot/OperationLog',
    authority: ['ADMIN', 'SUPERMANAGER'],
  },
  {
    ...
    routes: [
      {
        ...
        name: 'systemParams',
        component: '/Mixrobot/SystemParams',
        authority: ['ADMIN', 'SUPERMANAGER'],
      },
      {
        path: '/mixrobot/system/timezone',
        name: 'Timezone',
        component: '/Mixrobot/SystemTimeZone',
        authority: ['ADMIN', 'SUPERMANAGER', 'MANAGER'],
      },
      {
        path: '/mixrobot/system/webHook',
        name: 'webHook',
        component: '/Mixrobot/WebHook',
        hooks: ['dev'],
      },
    ],
  },
